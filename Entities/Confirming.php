...
class Confirming extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ...
            ['label' => 'Confirming', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['format_id', 'incoming_id', 'amount', 'account']],
            ['label' => 'Published', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['date_sent', 'completed', 'successful']],
        ];
